...
final class LoginViewController: UIViewController {
    ...
    private lazy var idTextField: UITextField = {
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "아이디", attributes: [NSAttributedString.Key.foregroundColor: UIColor.subLightGray])
        textField.font = .pretendard(to: .semiBold, size: 15)
        textField.backgroundColor = .subDarkGray
        textField.textColor = .subLightGray
    ...
    private lazy var passwordTextField: UITextField = {
        let textField = UITextField()
        textField.delegate = self
        textField.attributedPlaceholder = NSAttributedString(string: "비밀번호", attributes: [NSAttributedString.Key.foregroundColor: UIColor.subLightGray])
        textField.font = .pretendard(to: .semiBold, size: 15)
        textField.backgroundColor = .subDarkGray
        textField.textColor = .subLightGray
        textField.layer.cornerRadius = 3
    ...
    private lazy var loginButton: UIButton = {
        ...
        button.setTitleColor(.subLightGray, for: .normal)
        button.titleLabel?.font = .pretendard(to: .semiBold, size: 14)
        button.addTarget(self, action: #selector(loginButtonDidTap), for: .touchUpInside)
        button.layer.borderWidth = 1
        button.layer.borderColor = UIColor.subLightGray.cgColor
    ...
    private let bulkHeadView: UIView = {
        let view = UIView()
        view.backgroundColor = .subLightGray
    ...
    private lazy var createAccountButton: UIButton = {
        ...
        let attributedString = NSAttributedString(string: title, attributes: [
                ...
                .foregroundColor: UIColor.subLightGray,
    ...
    private func updateLoginButtonState() {
        ...
        if isEnabled {
            loginButton.backgroundColor = .subRed
            loginButton.layer.borderColor = .none
            loginButton.setTitleColor(.white, for: .normal)
        } else {
            loginButton.backgroundColor = .clear
            loginButton.layer.borderColor = UIColor.subLightGray.cgColor
            loginButton.layer.borderWidth = 1.0
            loginButton.setTitleColor(.subLightGray, for: .normal)
        }
    }
...
extension LoginViewController: UITextFieldDelegate {
    ...
    private func addToggleIdButton(to textField: UITextField) {
        ...
        clearButton.tintColor = .subLightGray
    ...
    private func addTogglePasswordButton(to textField: UITextField) {
        ...
        eyeButton.tintColor = .subLightGray
